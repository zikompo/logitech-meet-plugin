namespace Loupedeck.GoogleMeetPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.GoogleMeetPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.GoogleMeetPlugin.Resources.Resource.txt`.
